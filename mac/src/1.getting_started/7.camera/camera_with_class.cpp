...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Minecraft 2.0", nullptr, nullptr); // Windowed
    ...
    for(int i = 0 ; i < 10 ; i++)
    {
        ...
        cubePositions[i] = glm::vec3(x, z, y);
        x++;
    }
    ...
    unsigned char* image = SOIL_load_image(FileSystem::getPath("resources/textures/wood.png").c_str(), &width, &height, 0, SOIL_LOAD_RGB);
